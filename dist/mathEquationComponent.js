...
// module
exports.push([module.i, ".mainNavLogo{height:100%;background-color:#8064d6;float:left}#NavContainer{height:75px;border-top-color:#000;border-top-width:3px;border-top-style:solid;background-color:#ffdc78}#Page{background-color:#c88040;color:#cff;width:100%;height:100%;box-sizing:border-box;padding:8px;margin:0}#LatexImage{height:40%}#EquationsContainer{width:100%;position:fixed;display:flex;flex-direction:column;bottom:75px;z-index:-1;background-color:#fff;border-top-style:solid;border-top-width:1px;box-shadow:0 -2px 15px rgba(50,50,50,.35)}#ResizeIcon{display:block;margin:auto;opacity:.5;user-select:none;cursor:ns-resize}#ResizeIcon:hover{opacity:1}#MathTextEquationContainer{flex:1;display:flex;flex-direction:row}#SvgContainer{border-left-style:solid;border-left-width:1px}#HiddenCanvas{width:800px;display:none}#CanvasImgContainer{position:fixed;bottom:-100%}.mainItemsEquationContainer{height:100%;width:50%;border-width:0;resize:none;box-sizing:border-box;padding:20px}.mainNavBar{margin:0;padding:0}.mainNavBar>li{display:inline-block!important;color:#cfa}.mainNavButton{height:100%;padding-left:10px;padding-right:10px;float:left;font-size:30px;border-width:0;background-color:#ffdc78;font-family:Times New Roman;color:#000;box-shadow:none}.mainNavButton:hover,.mainNavButtonSelected{background-color:#aaaa78}.mainHideEquationsContainer{transition:1s}@media screen and (max-width:1000px){#MathTextEquationContainer{flex-direction:column}}@media screen and (max-width:1000px){#MathEquationText{width:100%;height:100%;border-width:0}}@media screen and (max-width:1000px){#SvgContainer{width:100%;height:100%;border:0;border-top-style:solid;border-top-width:1px}}", ""]);
...
let MathEquationAnywhere = class MathEquationAnywhere extends HTMLElement {
    constructor() {
        super();
        this.mathJaxConvert = new __WEBPACK_IMPORTED_MODULE_2__MathJaxConvert_ts__["a" /* MathJaxConvert */]();
...
let ConvertMathTypes = function (mathTypesString) {
    ...
    switch (mathTypesString) {
        case "MathML":
            ...
            break;
        case "AsciiMath":
            returnType = "AsciiMath" /* Ascii */;
            break;
        case "Tex":
            returnType = "Tex" /* Tex */;
            break;
        case "NoMathType":
            returnType = "NoMathType" /* NoMathType */;
            break;
        default:
...
class MathJaxConvert {
    constructor() {
        this.canvasToImage = new __WEBPACK_IMPORTED_MODULE_0__CanvasToImage_ts__["a" /* CanvasToImage */]();
    }
    queueEquation(ElmObject) {
        ...
        this.submitTimer = setTimeout(() => {
            ...
            if ("MathML" /* MathML */ == ElmObject.selectedMathType) {
...
/* harmony export (immutable) */ __webpack_exports__["a"] = MathJaxConvert;
...
var _user$project$MyCss$LatexImage = {ctor: 'LatexImage'};
...
}(
	{
			...
			_user$project$MyCss$NavLogo,
			{
				...
				_1: {
					...
					_0: _rtfeldman$elm_css$Css$backgroundColor(
						_rtfeldman$elm_css$Css$hex('#8064d6')),
					_1: {
						ctor: '::',
		...
		_1: {
			...
			_0: A2(
				...
				_user$project$MyCss$NavContainer,
				{
					ctor: '::',
					_0: _rtfeldman$elm_css$Css$height(
						_rtfeldman$elm_css$Css$px(_user$project$MyCss$heightNavContainer)),
					_1: {
						ctor: '::',
			...
			_1: {
				...
				_0: A2(
					_rtfeldman$elm_css$Css$id,
					_user$project$MyCss$Page,
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$backgroundColor(
							A3(_rtfeldman$elm_css$Css$rgb, 200, 128, 64)),
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Css$color(
								_rtfeldman$elm_css$Css$hex('CCFFFF')),
							_1: {
								ctor: '::',
				...
				_1: {
					...
					_0: A2(
						_rtfeldman$elm_css$Css$id,
						_user$project$MyCss$LatexImage,
						{
							ctor: '::',
							_0: _rtfeldman$elm_css$Css$height(
					...
					_1: {
						...
						_0: A2(
							_rtfeldman$elm_css$Css$id,
							_user$project$MyCss$EquationsContainer,
							{
								ctor: '::',
								_0: _rtfeldman$elm_css$Css$width(
									_rtfeldman$elm_css$Css$pct(100)),
															...
															_1: {
																...
																_1: {
																	...
																	_0: A4(
																		...
																		A4(_rtfeldman$elm_css$Css$rgba, 50, 50, 50, 0.35)),
																	_1: {ctor: '[]'}
																}
															}
														}
						...
						_1: {
							...
							_0: A2(
								_rtfeldman$elm_css$Css$id,
								_user$project$MyCss$ResizeIcon,
								{
									ctor: '::',
...
var _user$project$Main$getPageYOffset = _elm_lang$core$Native_Platform.outgoingPort(
	'getPageYOffset',
	function (v) {
		return v;
	});
		...
		switch (_p2.ctor) {
			...
			case 'SubmitEquation':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Main$sumitEquation(
						A2(
							_elm_lang$core$Json_Encode$encode,
							0,
...
var _user$project$Main$SubmitEquation = {ctor: 'SubmitEquation'};
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Main$id('elmContainer'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
				...
				},
				{
										...
										_1: {
											...
											_1: {
												...
												_0: _elm_lang$html$Html_Attributes$src(
													A2(_elm_lang$core$Basics_ops['++'], model.baseUrl, 'Img/resizeIcon.svg')),
												_1: {
													ctor: '::',
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _user$project$Main$id(_user$project$MyCss$MathTextEquationContainer),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
												...
												_1: {
													...
													_1: {
														...
														_0: _user$project$Main$class(
															{
																ctor: '::',
																_0: _user$project$MyCss$ItemsEquationContainer,
																_1: {ctor: '[]'}
															}),
														_1: {ctor: '[]'}
													}
...
var _user$project$Main$MouseChange = F2(
	function (a, b) {

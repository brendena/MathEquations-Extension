...
var testLoaded = __webpack_require__(1);
var Elm = __webpack_require__(2);
var ElmStylesheet = __webpack_require__(3);
							...
							_elm_lang$html$Html$img,
							{
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$src(
											A2(_elm_lang$core$Basics_ops['++'], model.baseUrl, 'images/logoClearBackground.svg')),
										_1: {ctor: '[]'}
									}
								}
							},
									...
									_0: A2(
										_elm_lang$html$Html$img,
										{
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$src(
													A2(_elm_lang$core$Basics_ops['++'], model.baseUrl, 'images/latex.svg')),
												_1: {ctor: '[]'}
											}
										},
										{ctor: '[]'}),
...
var _user$project$Stylesheets$fileStructure = _rtfeldman$elm_css$Css_File$toFileStructure(
	{
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
			...
			_1: _rtfeldman$elm_css$Css_File$compile(
				{
					ctor: '::',
					_0: _user$project$MyCss$css,
					_1: {ctor: '[]'}
				})
		},
		_1: {ctor: '[]'}
	});
var _user$project$Stylesheets$files = _elm_lang$core$Native_Platform.outgoingPort(
	'files',
	function (v) {
...
var _user$project$Stylesheets$main = A2(_rtfeldman$elm_css$Css_File$compiler, _user$project$Stylesheets$files, _user$project$Stylesheets$fileStructure)();

var Elm = {};
Elm['Stylesheets'] = Elm['Stylesheets'] || {};
if (typeof _user$project$Stylesheets$main !== 'undefined') {
    _user$project$Stylesheets$main(Elm['Stylesheets'], 'Stylesheets', undefined);
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__custom_elements__ = __webpack_require__(5);
